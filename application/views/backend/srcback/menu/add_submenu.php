    <!-- begin #content -->
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header text-center">เมนูย่อย <small>เช่น Windows </small></h1>
			<!-- end page-header -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">เพิ่มเมนูย่อย</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Ex. Windows 10" />
                                </div>
                                <div class="form-group">
                                    <label for="name">ชื่อเมนูย่อย <span class="text-danger">*</span></label>
                                    <select class="form-control" name="mainmenu_category">
                                        <option class="text-center" selected>-- เลือกหมวดหมู่เมนู --</option>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" name="title_submenu">
                                        <option class="text-center" selected>-- เลือกหัวข้อเมนูย่อย --</option>
                                ...
                                <button type="submit" class="btn btn-sm btn-primary m-r-5">เพิ่มเมนูย่อย</button>
                            </form>
                        </div>
                        <!-- end panel-body -->
                    </div>
