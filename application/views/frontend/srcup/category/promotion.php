            ...
            <div class="container">
                ...
                <div class="search-container">
                    ...
                    <div class="search-content">
                        ...
                        <?php
                            $no = $offset;
                            foreach($data_promotion as $getpromotion): ?>
                        <!-- BEGIN Container -->
                        <div class="search-item-container">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                       	<a href="<?=base_url('Home/product_detail'.'/'.$getpromotion->product_id); ?>" class="item-image btn btn-warning btn-md">ดูรายละเอียด</a>
                                </div>
                                <!-- END item -->
                            </div>
                            <!-- END item-row -->
