                ...
                <div class="search-container">
                    ...
                    <div class="search-content">
                        ...
                        <div class="search-toolbar">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>พบวินโดว์ทั้งหมด <?php echo $getcountwin; ?>  รายการ</h4>
                                </div>
                                <!-- END col-6 -->
                                <!-- BEGIN col-6 -->
                        ...
                        <?php
                            $no = $offset;
                            foreach($data_windows as $getwindows): ?>
                        <!-- BEGIN Container -->
                        <div class="search-item-container">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href=<?=base_url('Home/product_detail'.'/'.$getadobe->product_id); ?> class="item-image">
                                        <?php if($getadobe->product_img!=''){ ?>
                                        <img src="<?php echo base_url().'application/upload/product/'.$getwindows->product_img; ?>" alt="" />
                                ...
                                <div class="item item-thumbnail">
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="<?=base_url('Home/product_detail'.'/'.$getwindows->product_id); ?>"><?php echo $getwindows->product_name; ?><br /></a>
                                        </h4>
                                        <p class="item-desc"><?php echo substr(wordwrap($getwindows->product_detail,35,"<br>"),0,50); ?></p>
                                        <div class="item-price"><?php echo number_format($getwindows->product_mprice); ?> บาท</div>
                                        <div class="item-discount-price"><?php echo number_format($getwindows->product_vprice); ?> บาท</div>
                                    </div>
                                </div>
                                <div class="item item-thumbnail">
                                       	<a href="<?=base_url('Home/product_detail'.'/'.$getwindows->product_id); ?>" class="item-image btn btn-warning btn-md">ดูรายละเอียด</a>
                                </div>
                                <!-- END item -->
                            </div>
                            <!-- END item-row -->
