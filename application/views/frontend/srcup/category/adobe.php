                ...
                <div class="search-container">
                    ...
                    <div class="search-content">
                        ...
                        <div class="search-toolbar">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>พบอะโดบีซิสเต็มส์ทั้งหมด <?php echo $getcountadobe; ?>  รายการ</h4>
                                </div>
                                <!-- END col-6 -->
                                <!-- BEGIN col-6 -->
                        ...
                        <?php
                            $no = $offset;
                            foreach($data_adobe as $getadobe): ?>
                        <!-- BEGIN Container -->
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href=<?=base_url('Home/product_detail'.'/'.$getadobe->product_id); ?> class="item-image">
                                        ...
                                        <img src="<?php echo base_url().'application/upload/product/'.$getadobe->product_img; ?>" alt="" />
                                ...
                                <div class="item item-thumbnail">
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="<?=base_url('Home/product_detail'.'/'.$getadobe->product_id); ?>"><?php echo $getadobe->product_name; ?><br /></a>
                                        </h4>
                                        <p class="item-desc"><?php echo substr(wordwrap($getadobe->product_detail,35,"<br>"),0,50); ?></p>
                                        <div class="item-price"><?php echo number_format($getadobe->product_mprice); ?> บาท</div>
                                        <div class="item-discount-price"><?php echo number_format($getadobe->product_vprice); ?> บาท</div>
                                    </div>
                                </div>
                                <div class="item item-thumbnail">
                                       	<a href="<?=base_url('Home/product_detail'.'/'.$getadobe->product_id); ?>" class="item-image btn btn-warning btn-md">ดูรายละเอียด</a>
                                </div>
                                <!-- END item -->
                            </div>
                            <!-- END item-row -->
