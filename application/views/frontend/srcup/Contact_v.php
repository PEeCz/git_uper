            ...
            <div class="container">
                ...
                <div class="row row-space-30">
                    ...
                    <div class="col-md-8">
                        ...
                        ?>
                        <form class="form-horizontal" action="<?php echo base_url('Sendemail/send'); ?>" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" pattern="\d*" name="mobile" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Select Picture <span class="text-danger">*</span></label>
                                <div class="col-md-7">
                                    <input type="file" class="form-control" accept=".jpg,.png,.jpeg,.gif,.pdf,.docx,.doc" name="filename" required />
                                </div>
                            </div>
                            <div class="form-group">
